...
namespace FactorioProductionCells.ModUpdateScheduler.Services
{
    ...
    {
        // TODO: I hate implementing this service this way, but it's all I can manage right now. I feel like I ought to be retreiving the ModUpdateUser's Id from the database
